...
def get_options(verbose=True, **kwargs):
    ...
    options = {
        ...
        'xaxis' : [1, 'x-axis resolution in number of input profiles of the final gridded products. 1 for single casts; 2 for whole dives; more for longer horizontal averaging.'],
